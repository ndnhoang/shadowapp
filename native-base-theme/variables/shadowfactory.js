...
export default {
  ...
  // Color
  brandPrimary: platform === "ios" ? "#007aff" : "#FFF",
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === "ios" ? "#F8F8F8" : "#FFF",
  ...
  tabActiveBgColor: platform === "ios" ? "#cde1f9" : "#FFF",
  ...
  listItemSelected: platform === "ios" ? "#007aff" : "#FFF",
  ...
  segmentBorderColorMain: platform === "ios" ? "#a7a6ab" : "#FFF",
